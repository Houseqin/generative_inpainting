...
parser.add_argument('--validation_filename', default='./data/celeba/validation_shuffled.flist', type=str,
...
if __name__ == "__main__":
    ...
    for training_dir in training_dirs:
        # print(os.path.splitext(training_dir)[-1])
        # if os.path.splitext(training_dir)[-1] == '':
        #     continue
        # assert os.path.splitext(training_dir)[-1] != 'png' & os.path.splitext(training_dir)[-1] != 'jpg'
